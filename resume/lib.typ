...
#let tertiary-right-header(body) = {
  set text(weight: "light", size: 12pt)
  body
}
...
#let resume(
  ...
  show heading.where(level: 2): it => {
    set text(color-darkgray, size: 15pt, style: "normal", weight: "bold")
    it.body
  }
...
#let resume-item(body) = {
  set text(size: 12pt, style: "normal", weight: "light", fill: color-darknight)
...
#let resume-gpa(numerator, denominator, rank, rank_all, sigle, english) = {
  ...
  [
  #text[平均成绩 (排名)： #box[#strong[#numerator]/#denominator (#strong[#rank]/#rank_all)]]
  #text[#h(8em)]
  #text[英语水平：#english]
  #linebreak()
  #text[#h(2em)]
